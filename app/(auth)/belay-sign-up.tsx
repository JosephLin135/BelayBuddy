  ...
  const onSignUpPress = async () => {
    ...
    try {
      ...
      if (signUpAttempt.status === 'complete') {
        ...
        router.replace('/belay-profile-setup') // Go to profile setup page
      } else {
  ...
  return (
    ...
    <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor:'#f6f7f9' }}>
      ...
      <View style={{        
        ...
        <Text style={{ fontSize: 28, fontWeight: 'bold', marginBottom: 24, color: '#27526a' }}>BelayBuddy</Text>
...
export function BelayProfileSetup() {
  const { user } = useUser()
